...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar el pais de un atleta\n");
	}
	...
	private void ejectuarPaisSegunAtleta()
	{
		System.out.println("\n" + "Ver pais de un atleta en especifico" + "\n");
		String nombreAtleta= input("Nombre de atleta: ");
		Pais resultadoPais=calculadora.paisSegunAtleta(nombreAtleta);
		String nombrePais= resultadoPais.darNombre();
		
		System.out.println(nombreAtleta + " pertenece al pais:  " + nombrePais);
